---
title: '24. Time-series databases'
...
## 4. Worked Example — a fleet's CPU metrics (and the bomb that kills it)
...
- **The cardinality bomb (the cardinal sin).** A high-cardinality label (`user_id`, `request_id`, URL, email) multiplies series into the millions; at ~3–4 KB head RAM each, you OOM the database. Keep labels low-cardinality and bounded; push per-entity identifiers into traces/logs. This is §4's failure, and it's worth repeating because everyone does it once.
