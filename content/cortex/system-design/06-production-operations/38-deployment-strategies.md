---
title: '38. Deployment strategies'
...
**Progressive delivery** is canary + **automated analysis**: a controller (Argo Rollouts, Flagger) shifts traffic in steps, checks the new version's **golden signals** ([Lesson 37](/cortex/system-design/production-operations/observability)) against thresholds at each step, and **auto-promotes** if healthy or **auto-rolls-back** if not — no human staring at a dashboard at 2 a.m.
