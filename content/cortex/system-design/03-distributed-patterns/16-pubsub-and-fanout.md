...
| Term | Meaning |
|---|---|
| **Point-to-point** | one message → exactly one consumer (a work queue, Lesson 15) |
...
Model a feed. Each user has a **home timeline** (a cached list of recent post-ids from people they follow). Two users:
