---
title: '35. Authentication and authorization'
...
- **Weak password storage / no rate limiting.** Plaintext or fast hashes (MD5/SHA-1) are cracked instantly on breach. Use a **slow, salted KDF** (bcrypt/scrypt/argon2), rate-limit and lock out login attempts ([Lesson 22](/cortex/system-design/distributed-patterns/rate-limiting)), and offer MFA/passkeys.
