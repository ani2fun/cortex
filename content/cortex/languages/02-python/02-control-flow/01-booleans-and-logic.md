...
*Concrete bite.* Comparing floats with `==` is treacherous, because (from [Tutorial 3](/cortex/languages/python/first-steps/numbers-and-arithmetic)) floats are approximations:
