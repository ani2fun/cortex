...
The discipline is to implement *only the dunders you actually need* — they form the [data model](/cortex/languages/python/advanced/the-data-model), a large protocol surface, but each one is opt-in. Every output below was produced by running the code.
