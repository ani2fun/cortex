...
This builds on [Classes & Objects](/cortex/languages/python/object-oriented/classes-and-objects) and the [class-vs-instance](/cortex/languages/python/object-oriented/class-vs-instance) lookup rule — inheritance simply extends that lookup up a chain of classes. Every output below was produced by running the code — including the deliberate traceback.
