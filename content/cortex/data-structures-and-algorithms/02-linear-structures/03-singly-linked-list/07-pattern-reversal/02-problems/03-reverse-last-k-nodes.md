...
class Solution:
    def reverse_last_k_nodes(self, head, k):
        # Your code goes here — measure length, walk to the splice point
        # (n - k steps from head), reverse the suffix, stitch.
        pass
...
```testcases
{
  ...
  "cases": [
    { "args": { "head": "[5, 7, 3, 10]", "k": "2" }, "expected": "[5, 7, 10, 3]" },
    ...
    { "args": { "head": "[1, 2]", "k": "1" }, "expected": "[1, 2]" },
    { "args": { "head": "[1, 2]", "k": "2" }, "expected": "[2, 1]" },
    { "args": { "head": "[1, 2, 3, 4, 5]", "k": "0" }, "expected": "[1, 2, 3, 4, 5]" },
    { "args": { "head": "[1, 2, 3, 4, 5]", "k": "10" }, "expected": "[5, 4, 3, 2, 1]" }
  ]
}
```
