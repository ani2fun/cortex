...
/**
 * The Hello-counter demo page, kept as-is from the original cortex skeleton — it exercises Postgres (visit
      ...
      .render { (_, greetingS, recentS) =>
        <.main(
          ...
          <.div(
            ...
            <.h1(^.className := "text-3xl font-bold text-slate-900 dark:text-slate-50", "Cortex Demo"),
            <.p(
