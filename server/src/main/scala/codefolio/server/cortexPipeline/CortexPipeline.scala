...
import codefolio.shared.cortex.{CortexIndexWalker, Frontmatter}
 ...
 *     [[codefolio.shared.cortex.CortexIndexWalker]] consumes. The pipeline owns the walker invocation; this
