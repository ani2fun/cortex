...
import codefolio.shared.api.Endpoints.{BlogMetaItem, BlogPostFrontmatter}

/**
 * Lenient YAML-frontmatter parser for blog posts.
 *
 * Why a separate parser from Cortex's [[codefolio.shared.cortex.Frontmatter]]: blogs need richer fields
