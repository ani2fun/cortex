...
import codefolio.shared.cortex.CortexIndexWalker.CortexEntry
import zio.*
 ...
 * uses this fake also exercises the real [[codefolio.shared.cortex.CortexIndexWalker]] — the walker
